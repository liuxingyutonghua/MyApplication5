package mr_time.example.com.myapplication.activity;
...
import mr_time.example.com.myapplication.fragment.CourseFragment;
import mr_time.example.com.myapplication.fragment.ExercisesFragment;
import mr_time.example.com.myapplication.fragment.MyinfoFragment;
import mr_time.example.com.myapplication.utils.AnalysisUtils;
...
public class MainActivity extends FragmentActivity implements View.OnClickListener{
    ...
    private void setSelectStatus(int index) {
        switch (index){
            case 0:
                ...
                bottom_bar_text_course.setTextColor(Color.parseColor("#60E91E63"));
                ...
                tv_main_title.setText("家教中心");
                break;
            case 1:
                bottom_bar_image_exercises.setImageResource(R.drawable.main_exercises_icon_selected);
                bottom_bar_text_exercises.setTextColor(Color.parseColor("#60E91E63"));
                ...
                tv_main_title.setText("解答中心");
                break;
            case 2:
                bottom_bar_image_myinfo.setImageResource(R.drawable.main_my_icon_selected);
                bottom_bar_text_myinfo.setTextColor(Color.parseColor("#60E91E63"));
                bottom_bar_text_course.setTextColor(Color.parseColor("#666666"));
                bottom_bar_text_exercises.setTextColor(Color.parseColor("#666666"));
                bottom_bar_image_exercises.setImageResource(R.drawable.main_exercises_icon);
                bottom_bar_image_course.setImageResource(R.drawable.main_course_icon);
    ...
    private void initView() {
        ...
        tv_main_title.setText("爱学");
        title_bar.setBackgroundColor(Color.parseColor("#60E91E63"));
    }
